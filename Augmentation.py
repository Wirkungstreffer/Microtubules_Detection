...
images_path="images/" #path to original images
masks_path = "labels/"
img_augmented_path="images_aug/" # path to store aumented images
msk_augmented_path="labels_aug/" # path to store aumented images
