...
frame_second_proportion = 5/60        # 5 sec per frame
length_pixel_proportion = 9.1287   # 9.1287 pixel per uM

# Read the csv file
data_length_csv = pd.read_csv("Region_Segmentationn/data_output/Microtubules_Lengths_with_Seed_Concatenation.csv", header=None)
...
for column_number in non_nan_columns_index:
    ...
    original_image_save_path = "Region_Segmentation/data_output/NO.%s_Seed_Corresponding_Microtubules_Lengths_Scatter_Image.png" %(column_number+1)
    ...
    if breakpoint_number == 1:
        ...
        pwlf_image_save_path = "Region_Segmentation/data_output/NO.%s_Seed_Corresponding_Microtubules_Lengths_Linear_Regressioin.png" %(column_number+1)
...
rate_list_file_csv = open('Region_Segmentation/data_output/Microtubules_Rate_Event_List.csv','w',newline='')
...
positive_rate_list_file_csv = open('Region_Segmentation/data_output/Microtubules_Positive_Rate_Event_List.csv','w',newline='')
...
negative_rate_list_file_csv = open('Region_Segmentation/data_output/Microtubules_Negative_Rate_Event_List.csv','w',newline='')
